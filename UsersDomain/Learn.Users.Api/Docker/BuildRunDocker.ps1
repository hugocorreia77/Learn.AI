...
$ImageTag = "prd"
$ImageName = "learning-users-api:$($ImageTag)"
$ContainerName = "learning-users-api-$($ImageTag)"

# Construir a imagem Docker
Write-Host "Construindo a imagem Docker..."
docker build -f "C:\Development\sandbox\Learn\UsersDomain\Learn.Users.Api\Dockerfile" --force-rm  -t $ImageName --build-arg "BUILD_CONFIGURATION=Release" "C:\Development\sandbox\Learn"
